...
**IMPORTANT: This (very WIP) Free Pascal / Lazarus port explicitly requires the ["Unleashed" fork of trunk FPC and Lazarus](https://github.com/orgs/unleashedpascal/repositories) for the additional Delphi compatibility they add over the regular trunk versions. This will likely always be the case.**
